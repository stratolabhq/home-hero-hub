      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Alexa */}
            <div className="group border-2 border-gray-100 rounded-xl p-6 hover:border-[#2e6f40] transition-colors">
              ...
              <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                Voice control with Echo devices. Largest selection of compatible
                products.
              </p>
              <Link
                href="/compatibility"
                className="text-[#2e6f40] text-sm font-semibold group-hover:text-[#1f4d2b] transition-colors"
              >
            ...
            <div className="group border-2 border-gray-100 rounded-xl p-6 hover:border-[#2e6f40] transition-colors">
              ...
              <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                Google Assistant integration. Great with Android phones and
                Nest products.
              </p>
              <Link
                href="/compatibility"
            ...
            {/* HomeKit */}
            <div className="group border-2 border-gray-100 rounded-xl p-6 hover:border-[#2e6f40] transition-colors">
              <div className="w-12 h-12 bg-gray-700 rounded-xl mb-4 flex items-center justify-center">
                <span className="text-white font-bold text-lg">H</span>
              </div>
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Apple HomeKit</h3>
              <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                Siri voice control. Secure and private. Best for iPhone and
                iPad users.
              </p>
              <Link
                href="/compatibility"
            ...
            <div className="group border-2 border-gray-100 rounded-xl p-6 hover:border-[#2e6f40] transition-colors">
              ...
              <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                Advanced automation. Works with almost everything. Great for
                tech-savvy users.
              </p>
              <Link
                href="/compatibility"
